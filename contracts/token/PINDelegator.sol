...
import "./PINDelegate.sol";

contract PINDelegator is PINTokenInterface, PINDelegatorInterface {
    /**
     * @notice Construct a new PIN
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == gov, "PINDelegator::_setImplementation: Caller must be gov");
    ...
    function () external payable {
        require(msg.value == 0,"PINDelegator:fallback: cannot send value to fallback");
